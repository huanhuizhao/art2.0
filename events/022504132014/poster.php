...
$path = "http://www.artshu.com/art2.0/events/022504132014/";
$imagePATH = $path . "web600x800/";
$imageThumb =$path ."thumbnails/";

$files = array("photo 4_c.JPG", "photo 3_c.JPG", "photo 3_2.JPG", "photo 1_13.JPG", "photo 4_3.JPG", "photo 1_a.JPG", "photo 5_4.JPG", "photo 2_f.JPG", "photo 5_i.JPG", "photo 1_16.JPG", "photo 1_e.JPG", "photo 4_h.JPG", "photo 1_0_12.JPG", "photo 5_d.JPG", "photo 3_g.JPG", "photo 1_15.JPG", "photo 2_b.JPG", "photo 2_1.JPG", "photo 1_14.JPG");
$filesLoc = array();
$tiles = array();
foreach($files as $key=>$value) {
 ...
 if(time()<strtotime("Feb 25, 2014 PST")) {
    $header = "Coming Exhibition";
} else if (time() > strtotime ("April 13, 2014 PST")){
