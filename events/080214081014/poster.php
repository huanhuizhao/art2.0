...
$path = "http://www.artshu.com/art2.0/events/080214081014/";
$imagePATH = $path . "web600x800/";
$imageThumb =$path ."thumbnails/";

$files = array( "p1_3.JPG", "p3_2.JPG", "p2_2.JPG", "p3_5.JPG", "p1_1.JPG", "p1_2.JPG", "p1_5.JPG", "p3_1.JPG", "p2_1.JPG", "p3_4.JPG", "p1_4.JPG", "p3_3.JPG", "p2_4.JPG", "p2_5.JPG", "p2_3.JPG",);
$filesLoc = array();
$tiles = array();
foreach($files as $key=>$value) {
 ...
 if(time()<strtotime("Aug. 2, 2014 PST")) {
    $header = "Coming Exhibition";
} else if (time() > strtotime ("Aug. 10, 2014 PST")){
