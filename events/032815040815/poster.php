...
$path = "http://www.artshu.com/art2.0/events/032815040815/";
$imagePATH = $path . "web600x800/";
$imageThumb =$path ."thumbnails/";

$files = array ("pic.jpg", "pic1.JPG", "pic2.JPG", "pic3.JPG", "pic4.JPG", "pic5.JPG", "pic6.JPG", "pic7.JPG", "pic8.JPG" );
/*
$files = array( 
...
foreach($files as $key=>$value) {
 ...
 if(time()<strtotime("March 28 2015 PST")) {
    $header = "Coming Exhibition";
} else if (time() > strtotime ("April 8, 2015 PST")){
