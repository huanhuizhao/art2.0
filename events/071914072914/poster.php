...
$path = "http://www.artshu.com/art2.0/events/071914072914/";
$imagePATH = $path . "web600x800/";
$imageThumb =$path ."thumbnails/";

$files = array("photo8.JPG", "photo5.JPG", "photo4.JPG", "photo11.JPG", "preface.jpg", "photo16.JPG", "photo21.JPG", "photo7.JPG", "photo12.JPG", "photo9.JPG", "photo14.JPG", "photo15.JPG", "poster3.jpg", "photo17.JPG", "photo19.JPG", "photo10.JPG", "poster2.jpg", "poster1.jpg", "photo3.JPG", "photo22.JPG", "photo6.JPG", "photo1.JPG", "photo18.JPG", "photo13.JPG", "photo20.JPG", "photo23.JPG", "photo2.JPG");
$filesLoc = array();
$tiles = array();
foreach($files as $key=>$value) {
 ...
 if(time()<strtotime("July 19, 2014 PST")) {
    $header = "Coming Exhibition";
} else if (time() > strtotime ("July 29, 2014 PST")){
