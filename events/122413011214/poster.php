...
$path = "http://www.artshu.com/art2.0/events/122413011214/";
$imagePATH = $path . "web600x800/";
$imageThumb =$path ."thumbnails/";

$files = array("pic9.jpg", "photo6.JPG", "pic4.jpg", "pic2.jpg", "photo7.JPG", "pic3.jpg", "pic1.jpg", "pic8.jpg", "photo5.JPG", "photo4.JPG", "pic5.jpg", "photo 2.JPG", "photo8.JPG", "pic6.jpg", "photo 3.JPG", "pic7.jpg", "photo 1.JPG");
$filesLoc = array();
$tiles = array();
foreach($files as $key=>$value) {
 ...
 if(time()<strtotime("Dec. 24, 2013 PST")) {
    $header = "Coming Exhibition";
} else if (time() > strtotime ("Jan. 12, 2014 PST")){
