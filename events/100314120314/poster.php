...
$path = "http://www.artshu.com/art2.0/events/100314120314/";
$imagePATH = $path . "web600x800/";
$imageThumb =$path ."thumbnails/";

$files = array( "photo11.JPG", "photo12.JPG", "photo13.JPG", "photo14.JPG", "photo15.JPG", "photo51.JPG", "photo52.JPG", "photo53.JPG", "photo54.JPG", "photo55.JPG", "photo61.JPG", "photo62.JPG", "photo63.JPG", "photo64.JPG", "photo71.JPG", "photo72.JPG", "photo73.JPG", "photo74.JPG", "photo75.JPG", "photo8.JPG", 
               );
$filesLoc = array();
$tiles = array();
foreach($files as $key=>$value) {
 ...
 if(time()<strtotime("Oct. 3, 2014 PST")) {
    $header = "Coming Exhibition";
} else if (time() > strtotime ("Dec. 3, 2014 PST")){
