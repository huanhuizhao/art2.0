...
$path = "http://www.artshu.com/art2.0/events/041815043015/";
$imagePATH = $path . "web600x800/";
$imageThumb =$path ."thumbnails/";

$files = array ("artshu-11-XL.jpg", "artshu-123-XL.jpg", "artshu-129-XL.jpg", "artshu-18-XL.jpg", "artshu-35-XL.jpg", "artshu-45-X2.jpg", "artshu7.JPG", "artshu8.JPG",
...
foreach($files as $key=>$value) {
 ...
 if(time()<strtotime("April 18 2015 PST")) {
    $header = "Coming Exhibition";
} else if (time() > strtotime ("April 30, 2015 PST")){
