...
$path = "http://www.artshu.com/art2.0/events/062207032013/";
$imagePATH = $path . "web600x800/";
$imageThumb =$path ."thumbnails/";

$files = array("16.jpg", "19.jpg", "23.jpg", "25.jpg", "7.jpg", "9.JPG", "C23 - Copy.jpg", "i-bXJ2mRm - Copy.jpg", "i-H7G9bFj - Copy.jpg", "i-LK8D2xG-X3.jpg", "i-q8gSzSq - Copy.jpg", "i-rX6DXL5.jpg", "i-S2pszPJ-X3.jpg", "i-tHKrwfZ-X3.jpg", "i-TWZXZq9-X3.jpg", "i-xTR6wJp-X3.jpg", "IMG_3772.JPG", "IMG_3775.JPG", "unknow1.jpg", "unknow2.jpg");
//$files = array("1.png", "2.png", "3.png", "4.png", "5.png", "6.png", "7.png", "8.png", "9.png");
$filesLoc = array();
$tiles = array();
foreach($files as $key=>$value) {
 ...
 if(time()<strtotime("June 22, 2013 PST")) {
    $header = "Coming Exhibition";
} else if (time() > strtotime ("July 28, 2013 PST")){
