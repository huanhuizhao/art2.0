...
$path = "http://www.artshu.com/art2.0/events/022115030415/";
$imagePATH = $path . "web600x800/";
$imageThumb =$path ."thumbnails/";

$files = array ("p1.JPG", "p10.JPG", "p11.JPG", "p12.JPG", "p13.JPG", "p14.JPG", "p15.JPG", "p16.JPG", "p17.JPG", "p18.JPG", "p2.JPG", "p3.JPG", "p4.JPG", "p5.JPG", "p6.JPG", "p7.JPG", "p8.JPG", "p9.JPG",);
/*
$files = array( 
...
foreach($files as $key=>$value) {
 ...
 if(time()<strtotime("Feb. 21 2015 PST")) {
    $header = "Coming Exhibition";
} else if (time() > strtotime ("March 04, 2015 PST")){
