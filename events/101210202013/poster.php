...
$path = "http://www.artshu.com/art2.0/events/101210202013/";
$imagePATH = $path . "web600x800/";
$imageThumb =$path ."thumbnails/";

$files = array("photo_8.JPG", "photo_3.JPG", "photo_7.JPG", "photo_9.JPG", "photo_2.JPG", "photo_5.JPG", "photo_6.JPG", "photo_1.JPG", "photo_10.JPG", "photo_4.JPG");
$filesLoc = array();
$tiles = array();
foreach($files as $key=>$value) {
 ...
 if(time()<strtotime("Oct. 12, 2013 PST")) {
    $header = "Coming Exhibition";
} else if (time() > strtotime ("Oct. 20, 2013 PST")){
