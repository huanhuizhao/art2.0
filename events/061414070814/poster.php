...
$path = "http://www.artshu.com/art2.0/events/061414070814/";
$imagePATH = $path . "web600x800/";
$imageThumb =$path ."thumbnails/";

$files = array("photo6.JPG", "photo15.JPG", "photo7.JPG", "photo4.JPG", "photo13.JPG", "photo8.JPG", "photo14.JPG", "photo12.JPG", "photo10.JPG", "photo9.JPG", "photo3.JPG", "photo1.JPG", "photo11.JPG", "photo2.JPG");
$filesLoc = array();
$tiles = array();
foreach($files as $key=>$value) {
 ...
 if(time()<strtotime("June 14, 2014 PST")) {
    $header = "Coming Exhibition";
} else if (time() > strtotime ("July 8, 2014 PST")){
