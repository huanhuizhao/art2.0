...
$path = "http://www.artshu.com/art2.0/events/050314052114/";
$imagePATH = $path . "web600x800/";
$imageThumb =$path ."thumbnails/";

$files = array("1.jpg", "8.jpg", "3.jpg", "poster.jpg", "4.jpg", "5.jpg", "2.jpg", "7.jpg", "6.jpg");
$filesLoc = array();
$tiles = array();
foreach($files as $key=>$value) {
 ...
 if(time()<strtotime("May 03, 2014 PST")) {
    $header = "Coming Exhibition";
} else if (time() > strtotime ("May 21, 2014 PST")){
