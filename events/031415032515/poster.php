...
$path = "http://www.artshu.com/art2.0/events/031415032515/";
$imagePATH = $path . "web600x800/";
$imageThumb =$path ."thumbnails/";

$files = array ("p1.JPG", "p2.JPG", "p3.JPG", "p4.JPG", "p5.JPG", "Lakeside_Chill_at_Yushan.jpg", "3-14-invitation.jpg", "3-14-poster.jpg", "EPSON007_2.jpg", );
/*
$files = array( 
...
foreach($files as $key=>$value) {
 ...
 if(time()<strtotime("March 14 2015 PST")) {
    $header = "Coming Exhibition";
} else if (time() > strtotime ("March 25, 2015 PST")){
